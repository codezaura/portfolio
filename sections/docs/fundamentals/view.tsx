...
export function FundamentalsView() {
  ...
  const roleOfIDEs = (
    <>
      ...
      <CodeBlock
        code={`// 1. syntax highlighting
console.log("codezaura")
...
`}
      ...
      <CodeBlock
        code={`# 3. language support
print('hello!')

# 4. integrated terminal

# 5. version controlling systems ( github, gitlab )
...
`}
      ...
      <p>Are these not enough to use an IDEs.</p>
    </>
  )
